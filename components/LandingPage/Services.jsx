        ...
        <section className="flex flex-col items-center justify-center min-h-screen p-6 bg-red-50">
            <div className="p-8 rounded-lg text-center">
                ...
                <div className="flex gap-12 justify-center">
                    <Link href={'/chat'} className="group bg-[#397A4A] w-[340px] h-72 relative flex items-center justify-center rounded-xl overflow-hidden hover:scale-95 transition duration-250 hover:border-4 hover:border-[#397A4A]">
